...
export default function RoomsAndShare() {
  ...
  const getOutputTag = (list)=>{
      return list.map(each=><option id={each} key={each} value={each}>{each}</option>)
  }
  return (
        ...
        <div className={styles.row}>
          ...
          <div className={styles.col}>
              <fieldset>
                  ...
                  >
                      {
                          getOutputTag(["room not private","private room"])
                      }
                  </select>
              </fieldset>
            <fieldset>
            ...
            <fieldset>
                <label>private bath</label>
                <select 
                value={privateBath}
                onChange={e=>setPrivateBath(e.target.value)}
                >
                    {getOutputTag(["not private bath","private bath"])}
                </select>
            </fieldset>
            ...
            <fieldset>
                ...
                <select value={rentPeriod} onChange={e=>setRentPeriod(e.target.value)}>
                    {getOutputTag(["daily","weekly","monthly","yearly"])}
                </select>
            </fieldset>
          </div>
          <div className={styles.col}>
                ...
                return (
                  <div key={each} className={styles.checkbox}>
                    <input
                      ...
                      onChange={(e) =>
                        handleSelect(e, propertise, setPropertise)
                      }
                      value={each}
                    />
                    <label>{each}</label>
