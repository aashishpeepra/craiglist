  ...
  return (
    <div className={styles.largeForm}>
      ...
      <div className={styles.sect + " " + styles.extra}>
        <div className={styles.row} onChange={(e) => setHasLicense(e.target.value == "true"?true:false)}>
          <fieldset>
            <input defaultChecked={hasLicense} type="radio" name="license" value={"false"} />
            <label>unlicensed</label>
          </fieldset>
          <fieldset>
            <input type="radio" defaultChecked={hasLicense} name="license" value={"true"} />
