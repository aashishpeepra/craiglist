...
export default function WantedApartment() {
  ...
  const [flooring, setFlooring] = useState("wood");
        ...
        <div className={styles.row}>
          <div className={styles.col}>
            <fieldset>
              ...
              >
                {["wood", "carpet", "concrete", "tile", "earthen", "other"].map(
                  (each) => (
          ...
          <div className={styles.col}>
            {["cats okay", "dogs okay", "air conditioning"].map((each) => {
             return (<div
